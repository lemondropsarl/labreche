...
<html lang="en">
	<head>
		...
		<link
			rel="stylesheet"
			href="<?php echo base_url('assets/plugins/toastr/toastr.css') ?>"
		/>
		<link
			rel="stylesheet"
			href="<?php echo base_url('assets/dist/css/main.css') ?>"
		/>
		<link
			rel="stylesheet"
			type="text/css"
	...
	<body class="container-fluid">
		<nav class="navbar navbar-expand-md bg-dark navbar-dark fixed-top">
			<a
				href="<?php echo base_url('pos/check')?>"
						...
						<form class="form row">
							<div class="group-form col">
								...
								<input
									...
									name="filtre_pr_stock_fac"
									id="filtre_pr_stock_fac"
									class="form-control"
									required="required"
								/>
							</div>
			...
			<section class="col-md-6 col-sm-12 col-xs-12 card card-outline">
				...
				<div class="container">
					...
					<div class="row">
						...
						<h5 class="col-6 text-center">
							IDNAT:
							<?php echo strtoupper($item["id_nat"]); ?>
						</h5>
					</div>
					<?php
						}
				...
				<div class="form-inline non_print">
					...
					<div class="form-group col-3">
						<label for="monaie_cdf"> CDF </label
						><input
							type="radio"
							name="monaie_pay"
							id="monaie_cdf"
				...
				<div class="row non_print" style="margin-bottom: 2%">
					<div class="col-3">
						<button
							class="btn btn-danger print text-uppercase"
							id="btn_nouvelle_fac"
						>
					...
					<div class="col-3">
						<button
							class="btn btn-primary print text-uppercase"
							id="save-facture"
						>
