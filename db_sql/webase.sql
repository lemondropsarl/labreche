...
--
-- Host: localhost:3306
-- Generation Time: Aug 04, 2021 at 08:15 AM
...
('d5d31d8c741105e2aab656ead9261965bf967f33', '127.0.0.1', 16777215, );
...
CREATE TABLE `product` (
  ...
  `cat_id_fk` mediumint(4) NOT NULL,
  `vehicule_id_fk` mediumint(4) NOT NULL,
...
(1, '127.0.0.1', 'admin', '$2y$10$vh.dlN.OIKY3J.A0LUAKMuZZuOVuSzIuqcziDBgo8JX3fn/GSxp26', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, '0000-00-00 00:00:00.000000', '0000-00-00 00:00:00.000000', 1, 'CEDRIC', 'MATASO', 'LEMONDROP SARL', '0975899576');
...
CREATE TABLE `vehicule` (
  ...
  `vehicule_name` varchar(50) NOT NULL,
...
ALTER TABLE `product`
  ...
  ADD KEY `fk_ve_id` (`vehicule_id_fk`),
  ADD KEY `fk_cat_id` (`cat_id_fk`);
...
--
ALTER TABLE `categories`
  MODIFY `cat_id` mediumint(4) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `vehicule`
  MODIFY `vehicule_id` mediumint(4) NOT NULL AUTO_INCREMENT;
